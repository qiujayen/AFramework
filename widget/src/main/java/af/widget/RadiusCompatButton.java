...
public class RadiusCompatButton extends AppCompatButton {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, af.widget.R.styleable.RadiusCompatButton);

        mRadius = typedArray.getDimension(af.widget.R.styleable.RadiusCompatButton_round_radius, DEFAULT_RADIUS);
